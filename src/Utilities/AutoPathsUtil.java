...
public class AutoPathsUtil extends BasePathsUtil {
    ...
    public void drawAutoPaths() {
        ...
        rings.add(new Ring(86, 133));
        rings.add(new Ring(98, 133));
        ...
        if (!sweep) {
            ...
            Waypoint[] ringThWaypoints = new Waypoint[] {
                    ...
                    new Waypoint(3*PI/4, 0, 0, 0, 0, 0, 0.75),
            ...
            ringPath = new Path(new ArrayList<>(Arrays.asList(ringWaypoints)), ringThPath);
        }
        drawPath(ringPath);
        ...
        Waypoint[] intakeWobble2Waypoints2 = new Waypoint[] {
                ...
                new Waypoint(103, 44, 5*PI/12, -10, 0, 0, 2.5),
                new Waypoint(99, 34, 5*PI/12, -0.1, 50, 0, intakeWobble2Time),
        };
        ...
        if (ringCase == RingCase.Zero) {
            ...
            if (ringCase == RingCase.One) {
                parkWaypoints = new Waypoint[] {
                        new Waypoint(lX - 10, lY, 3*PI/4, -30, -30, 0, 0),
                        new Waypoint(89, 84, PI/2, -30, -30, 0, parkTime),
                };
            } else {
                parkWaypoints = new Waypoint[] {
                        new Waypoint(lX - 10, lY, 3*PI/4, -40, -40, 0, 0),
